...
/* begin private */
/* Name of package */
#define PACKAGE "dune-localfunctions"

/* Define to the address where bug reports for this package should be sent. */
#define PACKAGE_BUGREPORT "dune-devel@lists.dune-project.org"

/* Define to the full name of this package. */
#define PACKAGE_NAME "dune-localfunctions"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "dune-localfunctions 2.7-git"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "dune-localfunctions"
