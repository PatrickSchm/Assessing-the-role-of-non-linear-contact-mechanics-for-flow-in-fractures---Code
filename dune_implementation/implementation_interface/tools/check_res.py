...
path = "/home/paddy/Nextcloud/pkg/dune/results/non_linear_pf/analyse_mat_res/3d_test/res/"
err_dif = 1.e0
...
for imat in range(0,len(biot)):
    ...
    if difTest:
     ...
     # np.fabs(biot[imat].mat[0][0]>0.0) or np.fabs(HD[imat].mat[0][0]>0.0):
        printf("\033[0;37;40m======================================================\n")
        printf("\033[0;37;40mDifferenze Found in Element:, %d, Dif: %3.7e \n", biot[imat].iEl, SUM)
        printf("\033[0;37;40m======================================================\n")

        printf("\033[0;37;40mBIOT RES: \n")
