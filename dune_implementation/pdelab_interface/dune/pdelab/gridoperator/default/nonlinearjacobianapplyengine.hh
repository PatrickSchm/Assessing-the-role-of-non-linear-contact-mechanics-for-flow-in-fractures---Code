...
public:
  ...
  */
  ...
  void assembleZeroThickness(const EG & eg, const ITS & igs, const LFSUC & lfsu_cache, const LFSVC & lfsv_cache, int iMat)
  {
    rl_view.setWeight(local_assembler.weight());
    Dune::PDELab::LocalAssemblerCallSwitch<LOP, LOP::doAlphaVolume>::
    nonlinear_jacobian_apply_zero_thickness(lop, eg, igs, lfsu_cache.localFunctionSpace(), xl, zl, lfsv_cache.localFunctionSpace(), rl_view);
  }
