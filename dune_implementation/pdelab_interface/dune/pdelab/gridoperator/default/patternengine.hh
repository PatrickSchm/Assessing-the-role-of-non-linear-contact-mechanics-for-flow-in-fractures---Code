...
public:
  ...
  */
  ...
  {
    Dune::PDELab::LocalAssemblerCallSwitch<LOP, LOP::doPatternZeroThickness>::
    pattern_zero_thickness(lop, lfsu_cache.localFunctionSpace(), lfsv_cache.localFunctionSpace(), localpattern);
  }
