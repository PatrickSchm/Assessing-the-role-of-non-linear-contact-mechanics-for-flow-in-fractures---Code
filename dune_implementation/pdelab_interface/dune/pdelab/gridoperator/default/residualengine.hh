...
public:
  ...
  */
  ...
  void assembleUVVolume(const EG & eg, const LFSUC & lfsu_cache, const LFSVC & lfsv_cache, int iMat)
  {
    ...
    alpha_volume(lop, eg, lfsu_cache.localFunctionSpace(), xl, lfsv_cache.localFunctionSpace(), rl_view, iMat);
  }
  ...
  void assembleZeroThickness(const EG & eg, const ITS & igs, const LFSUC & lfsu_cache, const LFSVC & lfsv_cache, std::vector<int> indices)
  {
    ...
    alpha_zero_thickness(lop, eg, igs, lfsu_cache.localFunctionSpace(), xl, lfsv_cache.localFunctionSpace(), rl_view, indices);
  }
