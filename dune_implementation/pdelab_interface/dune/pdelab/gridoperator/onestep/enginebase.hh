...
public:
  ...
  */
  ...
  { return lae0->requireZeroThickness() || lae1->requireZeroThickness(); }
  ...
  void assembleZeroThickness(const EG & eg, const ITS & igs, const LFSU & lfsu, const LFSV & lfsv, std::vector<int> indices)
  {
    if (implicit)
      lae0->assembleZeroThickness(eg, igs, lfsu, lfsv, indices);
    lae1->assembleZeroThickness(eg, igs, lfsu, lfsv, indices);
  }
