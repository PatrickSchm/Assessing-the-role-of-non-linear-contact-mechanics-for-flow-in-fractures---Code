...
public:
  ...
  */
  ...
  void apply(M& A, V& z, W& r, typename W::field_type reduction)
  {
    ...
    solver.pardisoParameterArray()[3] = 3;
    std::cout << "pattern:" << std::endl;
    solver.analyzePattern(native(A));   // for this step the numerical values of A are not used

    std::cout << "factorize:" << std::endl;

    solver.factorize(native(A));
