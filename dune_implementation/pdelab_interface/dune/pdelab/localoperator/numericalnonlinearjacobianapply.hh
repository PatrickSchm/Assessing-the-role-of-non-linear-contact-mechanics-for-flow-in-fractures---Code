...
template<typename Imp>
class NumericalNonlinearJacobianApplyZeroThickness
{
public:
  NumericalNonlinearJacobianApplyZeroThickness ()
    : epsilon(1e-7)
  {}

  NumericalNonlinearJacobianApplyZeroThickness (double epsilon_)
    : epsilon(epsilon_)
  {}
